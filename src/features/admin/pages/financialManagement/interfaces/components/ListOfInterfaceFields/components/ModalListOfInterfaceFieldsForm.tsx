...
import { createListOfInterfaceFields } from '../services/ListOfInterfaceFieldsSevice'
...
export const ModalListOfInterfaceFieldsForm: React.FC<ModalinterfacesProps> = ({
    showModal,
    setShowModal,
    InterfaceId
}) => {
    ...
    const onSuccess = async (values: lnterfacesListInterfaceFields) => {
        try {
            ...
            await createListOfInterfaceFields(values)
