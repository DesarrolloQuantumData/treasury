...
import { ModalAccountsForm } from './components/ModalAccountsForm'
import { getExcelAccounts } from './services/accountService'
...
export const AccountsPage: React.FC = () => {
  ...
  const downloadExcelFile = async () => {
    try {
      const response = await getExcelAccounts()
  ...
  return (
    <div className='m-20 bg-slate-50 p-5 border-2 rounded-xl'>
      ...
      <AccountsTable />
      <ModalAccountsForm setShowModal={setShowModal} showModal={showModal} />
