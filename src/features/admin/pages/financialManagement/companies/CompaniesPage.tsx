...
import { ModalCompaniesForm } from './components/ModalCompaniesForm'
import { getExcelCompanies } from './services/companyService'
...
export const CompaniesPage: React.FC = () => {
  ...
  const downloadExcelFile = async () => {
    try {
      const response = await getExcelCompanies()
  ...
  return (
    <div className='m-20 bg-slate-50 p-5 border-2 rounded-xl'>
      ...
      <CompaniesTable />
      <Outlet />
      <ModalCompaniesForm setShowModal={setShowModal} showModal={showModal} />
